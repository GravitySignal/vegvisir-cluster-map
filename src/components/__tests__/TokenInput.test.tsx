...
describe("TokenInput", () => {
  ...
  it("renders numeric controls with defaults in address mode", () => {
    render(<TokenInput onSubmit={vi.fn()} isLoading={false} />);
    const inputs = screen.getAllByRole("spinbutton");
    expect(inputs[0]).toHaveValue(80);  // Max nodes
    expect(inputs[1]).toHaveValue(250); // Max transfers/address
  });
